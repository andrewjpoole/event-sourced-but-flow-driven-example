...
public class DbQueryProvider : IDbQueryProvider
{
    public const string InsertDomainEventQuery = @$"
        ...
        SELECT Id, {nameof(QueryParameters.StreamId)}, {nameof(QueryParameters.Version)}, {nameof(QueryParameters.EventClassName)}, {nameof(QueryParameters.SerialisedEvent)}, TimestampCreateUTC
        FROM DomainEvents
